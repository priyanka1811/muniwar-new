                    ...
                    <div className="mobile-header-content-area">
                        ...
                        <div className="perfect-scroll">
                                        ...
                                        <div className="notifications-item">
                                            <div className="item-notify">
                                                ...
                                                <div className="item-info">
                                                    <p className="color-grey-500 font-xs"><strong className="font-xs-bold">Steven Job</strong>like started a poll in your post “How to be a good trader in 2026”</p>
                                                </div>
                            ...
                            <div className="site-copyright color-grey-400 mt-0">
                                ...
                                <div className="mb-0">Copyright 2026 © IORI - Marketplace Template.<br />Designed by<Link href="/http:/alithemes.com" target="_blank">&nbsp; AliThemes</Link></div>
                            </div>
                        </div>
                    </div>
                </div>
