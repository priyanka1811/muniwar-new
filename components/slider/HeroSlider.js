...
const HeroSlider = () => {
    const data = [{ img: "placed.png" }, { img: "cuebiq.png" }, { img: "factual.png" }, { img: "placeiq.png" }, { img: "airmeet.png" }, { img: "spen.png" }, { img: "klippa.png" }, { img: "matrix.png" }];
                                    ...
                                    <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                                        <div className="box-info-banner11">
                                            ...
                                            <div className="mt-30 d-flex">
                                                <img className="w-50 mr-10" src="assets/imgs/template/appstore.png" alt="iori" />
                                                <img className="w-50" src="assets/imgs/template/google-play.png" alt="iori" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
