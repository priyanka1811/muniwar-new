                ...
                <section className="section pt-90 banner-about">
                    <div className="container text-center">
                        ...
                        <h2 className="color-brand-1 mb-15">
                            We are a digital agency that tackles <br className="d-none d-lg-block" />
                            all your online challenges.
                        </h2>
                        <p className="font-md color-grey-400 mb-30">
                            Social media networks are open to all. Social media is typically used for social interation and <br className="d-none d-lg-block" />
                            ...
                            <div className="col-lg-6">
                                <div className="item-core mb-30">
                                    ...
                                    <div className="item-desc">
                                        ...
                                        <span className="color-grey-500 font-xs">Chairman of the board</span>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                    ...
                    <div className="container">
                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                    <div className="box-info-video">
                                        <img className="bd-rd8 d-block" src="assets/imgs/page/about/img3.png" alt="iori" />
                                    </div>
                                </div>
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                    <div className="box-info-video mt-30 mb-30">
                                        ...
                                        <h3 className="color-brand-1 mt-10 mb-15">
                                            Behind every brand is an <br className="d-none d-lg-block" />
                                            interesting story
                                        </h3>
                        ...
                        <div className="box-story box-story-2">
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6">
                                    <div className="box-info-video">
                                        <img className="bd-rd8 d-block" src="assets/imgs/page/about/img4.png" alt="iori" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-7 bg-testimonials position-relative">
                                ...
                                <div className="ml-100">
                                    <div className="card-testimonial-list">
                                        <div className="d-flex align-items-center">
                                            <div className="box-author mb-10">
                                                <Link href="#">
                                                    <img src="assets/imgs/page/homepage2/author2.png" alt="iori" />
                                                </Link>
                                                <div className="author-info">
                                                    <Link href="#">
                                                        <span className="font-md-bold color-brand-1 author-name">Guy Hawkins</span>
                                            ...
                                            <div className="rating text-end">
                                                ...
                                                <img src="assets/imgs/template/icons/star.svg" alt="iori" />
                                                <img src="assets/imgs/template/icons/star.svg" alt="iori" />
                                                <img src="assets/imgs/template/icons/star-gray.svg" alt="iori" />
                                            </div>
                                        </div>
                                        <p className="font-md color-grey-500">Access the same project through five different dynamic views: a kanban board, Gantt chart, spreadsheet, calendar or simple task list.</p>
                                    </div>
                                ...
                                <div className="card-testimonial-list">
                                    <div className="d-flex align-items-center">
                                        <div className="box-author mb-10">
                                            <Link href="#">
                                                <img src="assets/imgs/page/homepage2/author3.png" alt="iori" />
                                            </Link>
                                            <div className="author-info">
                                                <Link href="#">
                                                    <span className="font-md-bold color-brand-1 author-name">Guy Hawkins</span>
